...
public class FinePaymentTM {
    ...
    public FinePaymentTM() {
    }

    public FinePaymentTM(int fineNo, String bookId, String memberId, int noOfDaysPassed, double amount) {
        this.fineNo = fineNo;
        this.bookId = bookId;
